...
public class Petugas extends User implements HakPetugas{
    ...
    public void tampilRequestPengambilanBarang() {
        ...
        for (int i = 0; i < kumpulanRequestPengambilanBarang.size(); i++){
            System.out.printf("%-5s%-24s%-50s%s\n", String.valueOf(i + 1), kumpulanRequestPengambilanBarang.get(i).getTanggalPengambilanBarang(), Main.getNamaBarangDariIdBarang(kumpulanRequestPengambilanBarang.get(i).getIdBarang()), Main.getNamaPengambilDariIdPengambil(kumpulanRequestPengambilanBarang.get(i).getIdPengambil()),Main.getNamaPenemuDariIdPenemu(kumpulanBarangTemu.get(i).getIdPenemu()));
        }
        System.out.println("$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
    }
