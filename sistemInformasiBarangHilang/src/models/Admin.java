...
public class Admin extends User implements HakPetugas{
    ...
    public void registerPetugas(String idPetugas, String namaPetugas, String emailPetugas, String nomorTeleponPetugas,
            String usernamePetugas, String passwordPetugas) {
        kumpulanPetugas.add(new Petugas(idPetugas, namaPetugas, emailPetugas, nomorTeleponPetugas, usernamePetugas,
                passwordPetugas));
    }
    ...
    public void tampilPetugas() {
        ...
        System.out.println(
                "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        System.out.printf("%-5s%-50s%-50s%-15s%-20s%s\n", "No", "Nama", "Email", "Nomor Telepon", "Username",
                "Password");
        System.out.println(
                "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$");
        for (int i = 0; i < kumpulanPetugas.size(); i++) {
            System.out.printf("%-5s%-50s%-50s%-15s%-20s%s\n", String.valueOf(i + 1),
                    kumpulanPetugas.get(i).getNamaPengguna(), kumpulanPetugas.get(i).getEmailPengguna(),
                    kumpulanPetugas.get(i).getNomorTeleponPengguna(), kumpulanPetugas.get(i).getUsernamePengguna(),
                    kumpulanPetugas.get(i).getPasswordPengguna());
        }
        System.out.println(
                "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
    }
    ...
    public void tampilCivitasAkademik() {
        ...
        for (int i = 0; i < kumpulanCivitasAkademik.size(); i++) {
            System.out.printf("%-5s%-50s%-50s%-15s%-20s%-20s%s\n", String.valueOf(i + 1),
                    kumpulanCivitasAkademik.get(i).getNamaPengguna(), kumpulanCivitasAkademik.get(i).getEmailPengguna(),
                    kumpulanCivitasAkademik.get(i).getNomorTeleponPengguna(),
                    kumpulanCivitasAkademik.get(i).getUsernamePengguna(),
                    kumpulanCivitasAkademik.get(i).getPasswordPengguna(),
                    kumpulanCivitasAkademik.get(i).getPeranCivitasAkademik());
        }
        System.out.println(
                "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
    }
    ...
    public void tampilPengambilanBarang() {
        ...
        for (int i = 0; i < kumpulanPengambilanBarang.size(); i++) {
            System.out.printf("%-5s%-24s%-50s%s\n", String.valueOf(i + 1),
                    kumpulanPengambilanBarang.get(i).getTanggalPengambilanBarang(),
                    Main.getNamaBarangDariIdBarang(kumpulanPengambilanBarang.get(i).getIdBarang()),
                    Main.getNamaPengambilDariIdPengambil(kumpulanPengambilanBarang.get(i).getIdPengambil()));
        }
        System.out.println(
                "$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$\n");
    }
